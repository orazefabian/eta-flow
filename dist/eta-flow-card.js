...
`,oe=[{name:"title",selector:{text:{}}},{name:"show_edge_labels",selector:{boolean:{}}},{name:"node_background",selector:{text:{}}}],ne=[{name:"primary",selector:{entity:{}}},{name:"secondary",selector:{entity:{}}},{name:"state",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"color",selector:{text:{}}}],se=[{name:"type",selector:{select:{mode:"dropdown",options:[{value:"power",label:"Power / numeric sensor"},{value:"state",label:"On-off state (pump, …)"},{value:"delta",label:"Temperature difference"}]}}},{name:"entity",selector:{entity:{}}},{name:"from_entity",selector:{entity:{}}},{name:"to_entity",selector:{entity:{}}},{name:"threshold",selector:{number:{mode:"box",step:"any"}}},{name:"power_reference",selector:{number:{mode:"box",step:"any"}}},{name:"show_label",selector:{boolean:{}}},{name:"label_entity",selector:{entity:{}}},{type:"expandable",name:"pump",title:"Pump glyph",schema:[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"hide_label",selector:{boolean:{}}}]}],re={title:"Title",show_edge_labels:"Show values on the connections",node_background:"Node fill color (CSS color, optional)",primary:"Primary value",secondary:"Secondary value",state:"Status pill",name:"Name",icon:"Icon",color:"Accent color (CSS color)",type:"Flow mode",entity:"Entity",from_entity:"Warm side",to_entity:"Cold side",threshold:"Threshold",power_reference:"Value at full speed",show_label:"Show this value on the line",label_entity:"Label entity",hide_label:"Hide the pump name"};function ae(t){const e={};for(const[i,o]of Object.entries(t))if(null!=o&&""!==o){if("object"==typeof o&&!Array.isArray(o)){const t=ae(o);t&&(e[i]=t);continue}e[i]=o}return Object.keys(e).length?e:void 0}let ce=class extends lt{constructor(){super(...arguments),this._label=t=>re[t.name]??t.title??t.name}setConfig(t){this._config={nodes:{},edges:{},...t}}_nodeIds(){const t=Object.keys(Tt);for(const e of Object.keys(this._config.nodes??{}))t.includes(e)||t.push(e);return t}_edgeKeys(){const t=Bt.map(t=>t.key);for(const e of Object.keys(this._config.edges??{}))t.includes(e)||t.push(e);return t}_nodeSchema(){return this._nodeIds().map(t=>({type:"expandable",name:t,title:this._config.nodes?.[t]?.name??Tt[t]?.label??t,icon:Tt[t]?.icon,schema:ne}))}_edgeSchema(){return this._edgeKeys().map(t=>({type:"expandable",name:t,title:this._edgeTitle(t),schema:se}))}_edgeTitle(t){const e=Bt.find(e=>e.key===t),i=this._config.edges?.[t],o=i?.from??e?.from,n=i?.to??e?.to;if(!o||!n)return t;const s=t=>this._config.nodes?.[t]?.name??Tt[t]?.label??t;return`${s(o)} → ${s(n)}`}render(){if(!this._config||!this.hass)return K;const{title:t,show_edge_labels:e,node_background:i}=this._config;return q`
    ...
    `}_cardChanged(t){t.stopPropagation();const e=t.detail.value;this._emit({...this._config,title:e.title||void 0,show_edge_labels:e.show_edge_labels||void 0,node_background:e.node_background||void 0})}_nodesChanged(t){t.stopPropagation();const e=t.detail.value,i={};for(const[t,o]of Object.entries(e)){const e=ae({...this._config.nodes?.[t],...o});e&&(i[t]=e)}this._emit({...this._config,nodes:i})}_edgesChanged(t){t.stopPropagation();const e=t.detail.value,i={};for(const[t,o]of Object.entries(e)){const e=ae({...this._config.edges?.[t],...o});e&&(i[t]=e)}this._emit({...this._config,edges:i})}_emit(t){this._config=t,xt(this,"config-changed",{config:t})}};ce.styles=r`
    .card-config {
      display: flex;
  ...
  `,t([pt({attribute:!1})],ce.prototype,"hass",void 0),t([_t()],ce.prototype,"_config",void 0),ce=t([dt("eta-flow-card-editor")],ce),console.info("%c ETA-FLOW-CARD %c v0.3.0 ","color: #fff; background: #4caf50; font-weight: 700;","color: #4caf50; background: #1c1c1c;"),window.customCards=window.customCards||[],window.customCards.push({type:Nt,name:"ETA Flow Card",description:"Animated heat-flow visualization for ETA heating systems (pellet, log & solar).",preview:!0,documentationURL:"https://github.com/orazefabian/eta-flow"});const le=(t,e,i)=>Math.max(e,Math.min(i,t)),he=.58;function de(t,e){return e.reduce((e,i)=>e+function(t,e){const i=Math.min(t.x2,e.x2)-Math.max(t.x1,e.x1),o=Math.min(t.y2,e.y2)-Math.max(t.y1,e.y1);return i>0&&o>0?i*o:0}(t,i),0)}function ue(t,e,i){const o=i.textLength??i.text.length*i.fontSize*he,n=1.25*i.fontSize;return{x1:t-o/2,y1:e-n/2,x2:t+o/2,y2:e+n/2}}const fe=["power","state","delta"],pe=["circle","badge","gauge"];function _e(t){const e={};if(!t?.states)return e;const i=Object.keys(t.states).filter(t=>t.startsWith("sensor.")),o=new Set;for(const[t,n]of Ht){const s=i.find(t=>!o.has(t)&&n.test(t.toLowerCase()));s&&(e[t]=s,o.add(s))}return e}function me(t,e,i,o,n=4){const s=e.x-t.x,r=e.y-t.y,a=Math.hypot(s,r)||1,c=s/a,l=r/a;return{x1:t.x+c*(i+n),y1:t.y+l*(i+n),x2:e.x-c*(o+n),y2:e.y-l*(o+n)}}let ge=class extends lt{constructor(){super(...arguments),this._entityIds=[],this._widthPx=0,this._placeholder=!1}connectedCallback(){super.connectedCallback(),this._observeSize()}disconnectedCallback(){this._resize?.disconnect(),this._resize=void 0,super.disconnectedCallback()}firstUpdated(){this._observeSize()}_observeSize(){if(this._resize)return;const t=this.renderRoot?.querySelector(".flow-wrap");t&&(this._resize=new ResizeObserver(t=>{const e=t[0]?.contentRect.width??0,i=Math.round(e);i!==this._widthPx&&(this._widthPx=i)}),this._resize.observe(t))}_unitsPerPx(){return this._widthPx>0?400/this._widthPx:1}_minFont(){return 9.5*this._unitsPerPx()}_font(t){return Math.max(t,this._minFont())}_isNarrow(){return this._widthPx>0&&this._widthPx<290}_fit(t,e,i){const o=this._font(e);if(t.length*o*he<=i)return{text:t,fontSize:o};const n=Math.max(this._minFont(),i/(t.length*he));return{text:t,fontSize:n,textLength:t.length*n*he>i+.5?i:void 0}}_fitLabel(t,e,i){const o=this._font(e),n=Math.floor(i/(o*he));return t.length<=n?{text:t,fontSize:o}:n<2?{text:t.slice(0,1),fontSize:o}:{text:`${t.slice(0,n-1).trimEnd()}…`,fontSize:o}}static async getConfigElement(){return document.createElement("eta-flow-card-editor")}static getStubConfig(t){const e={puffer:{},solar:{},kessel:{},warmwasser:{},heizkreis:{},aussen:{}};for(const[i,o]of Object.entries(_e(t)))e[i]={...e[i],primary:o};return{type:`custom:${Nt}`,title:"Heizung",nodes:e}}setConfig(t){if(!t)throw new Error("Invalid configuration");!function(t){const e=new Set([...Object.keys(Tt),...Object.keys(t.nodes??{})]);for(const[e,i]of Object.entries(t.nodes??{}))if(i){if(!Tt[e]&&(void 0===i.x||void 0===i.y))throw new Error(`eta-flow-card: custom node "${e}" needs an x and y position (0..400).`);if(i.kind&&!pe.includes(i.kind))throw new Error(`eta-flow-card: node "${e}" has kind "${i.kind}" — expected ${pe.join(", ")}.`);if(void 0!==i.min&&void 0!==i.max&&i.max<=i.min)throw new Error(`eta-flow-card: node "${e}" needs max greater than min.`)}for(const[i,o]of Object.entries(t.edges??{}))if(o){if(o.type&&!fe.includes(o.type))throw new Error(`eta-flow-card: edge "${i}" has type "${o.type}" — expected ${fe.join(", ")}.`);for(const t of["from","to"]){const n=o[t];if(n&&!e.has(n))throw new Error(`eta-flow-card: edge "${i}" points ${t} unknown node "${n}".`)}if(!(Bt.some(t=>t.key===i)||o.from&&o.to))throw new Error(`eta-flow-card: custom edge "${i}" needs both from and to.`)}for(const i of t.control_links??[])for(const t of["from","to"])if(!e.has(i[t]))throw new Error(`eta-flow-card: control_link points ${t} unknown node "${i[t]}".`)}(t),this._config={nodes:{},edges:{},...t},this._entityIds=function(t){const e=new Set,i=t=>{t&&e.add(t)};for(const e of Object.values(t.nodes??{}))if(e){i(e.primary),i(e.secondary),i(e.state),i(e.level);for(const t of e.layers??[])i(t)}for(const e of Object.values(t.edges??{}))e&&(i(e.entity),i(e.from_entity),i(e.to_entity),i(e.label_entity),i(e.pump?.entity));return i(t.solarpumpe?.entity),[...e]}(this._config)}getCardSize(){return 6}getGridOptions(){return{columns:12,min_columns:6,rows:"auto"}}shouldUpdate(t){if(!this._config)return!1;if(t.size>1||!t.has("hass"))return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._entityIds)if(e.states[t]!==this.hass.states[t])return!0;return e.locale!==this.hass.locale||e.themes!==this.hass.themes}willUpdate(){this._placeholder=!!this.hass&&!this._entityIds.some(t=>this.hass.states[t])}render(){if(!this._config||!this.hass)return K;const t=this._nodeIds().filter(t=>this._nodeVisible(t)),e=this._resolvedEdges().filter(e=>t.includes(e.from)&&t.includes(e.to)),i=(this._config.control_links??qt).filter(e=>t.includes(e.from)&&t.includes(e.to)),o=[];for(const e of t){const t="circle"===this._nodeKind(e)?this._circleIconSpec(e):this._badgeIconSpec(e);t&&o.push(t)}for(const t of e){const e=this._pumpIconSpec(t);e&&o.push(e)}const n=this._config.node_background?`--eta-node-fill: ${this._config.node_background}`:K,s=this._layoutLabels(e,t);return q`
      <ha-card style=${n}>
    ...
    `}_layoutLabels(t,e){const i={edges:new Map,pumps:new Map};if(this._isNarrow())return i;const o=[];for(const t of e){const e=this._geom(t);if(!e)continue;const i=this._nodeRadius(t);o.push({x1:e.x-i,y1:e.y-i,x2:e.x+i,y2:e.y+i});const n=this._nodeLabelFitted(t);o.push(ue(e.x,this._nodeLabelY(e,i,n),n))}for(const e of t){const t=this._pumpCenter(e);if(!t)continue;const i=Ut+2;o.push({x1:t.x-i,y1:t.y-i,x2:t.x+i,y2:t.y+i})}for(const e of t){const t=this._edgePump(e.key),n=this._pumpCenter(e);if(!t||!n||t.hide_label)continue;const s=this._fitLabel(t.name??Lt,11,84),r=this._placeNear(n,Ut+s.fontSize,s,o);r&&(o.push(r.box),i.pumps.set(e.key,{...s,x:r.x,y:r.y}))}for(const e of t){const t=this._config.edges?.[e.key];if(!(t?.show_label??this._config.show_edge_labels??!1))continue;const n=Jt(t,this.hass);if(!n)continue;const s=this._geom(e.from),r=this._geom(e.to);if(!s||!r)continue;const{x1:a,y1:c,x2:l,y2:h}=me(s,r,this._nodeRadius(e.from),this._nodeRadius(e.to)),d=this._fit(n,10,96),u=Math.hypot(l-a,h-c)||1,f=-(h-c)/u,p=(l-a)/u,_=.9*d.fontSize+5;let m;for(const t of[.5,.62,.38,.74,.26])for(const e of[1,-1])for(const i of[1,1.8,2.6]){const n=_*i*e,s=a+(l-a)*t+f*n,r=c+(h-c)*t+p*n,u=ue(s,r,d);if(u.x1<1||u.x2>399||u.y1<1||u.y2>399)continue;const g=de(u,o)+8*Math.abs(t-.5)+6*(i-1)+(1===e?0:1);(!m||g<m.cost)&&(m={cost:g,x:s,y:r,box:u})}m&&(o.push(m.box),i.edges.set(e.key,{...d,x:m.x,y:m.y}))}return i}_placeNear(t,e,i,o){const n=(i.textLength??i.text.length*i.fontSize*he)/2;let s;return[{x:1,y:0},{x:0,y:1},{x:-1,y:0},{x:0,y:-1}].forEach((r,a)=>{const c=0===r.y?e+n:e,l=t.x+r.x*c,h=t.y+r.y*c,d=ue(l,h,i);if(d.x1<1||d.x2>399||d.y1<1||d.y2>399)return;const u=de(d,o)+2*a;(!s||u<s.cost)&&(s={cost:u,x:l,y:h,box:d})}),s}_pumpCenter(t){if(!this._edgePump(t.key)?.entity)return;const e=this._geom(t.from),i=this._geom(t.to);return e&&i?{x:(e.x+i.x)/2,y:(e.y+i.y)/2}:void 0}_nodeLabelFitted(t){const e=this._nodeRadius(t);return this._fitLabel(this._nodeLabel(t),le(.3*e,11,16),Math.max(2.4*e,76))}_nodeLabelY(t,e,i){return t.y+e+.8*i.fontSize+3}_renderNodeLabel(t,e,i){const o=this._nodeLabelFitted(t);return W`<text
      class="node-label"
      x=${e.x}
      y=${this._nodeLabelY(e,i,o)}
      dominant-baseline="central"
      style=${`font-size:${o.fontSize.toFixed(1)}px`}
    >${o.text}</text>`}_nodeIds(){const t=Object.keys(Tt);for(const e of Object.keys(this._config.nodes??{}))t.includes(e)||t.push(e);return t}_cfg(t){return this._config.nodes?.[t]}_geom(t){const e=this._cfg(t),i=Tt[t],o=e?.x??i?.x,n=e?.y??i?.y;if(void 0!==o&&void 0!==n)return{x:o,y:n}}_nodeKind(t){return this._cfg(t)?.kind??Tt[t]?.kind??Ft}_nodeColor(t){return this._cfg(t)?.color??Tt[t]?.color??jt}_nodeRadius(t){return this._cfg(t)?.radius??Tt[t]?.radius??Dt}_nodeStroke(t){return this._cfg(t)?.stroke_width??2.5}_nodeIcon(t){return this._cfg(t)?.icon??Tt[t]?.icon??It}_nodeLabel(t){return this._cfg(t)?.name??Tt[t]?.label??t}_hasData(t){return!!(t?.primary||t?.secondary||t?.state||t?.level||t?.layers?.length)}_nodeEntity(t){const e=this._cfg(t);return e?.primary??e?.level??e?.state??e?.secondary??e?.layers?.[0]}_edgeEntity(t){const e=this._config.edges?.[t];return e?.entity??e?.label_entity??e?.from_entity}_actionsFor(t,e){const i=t?{action:"more-info"}:{action:"none"};return{entity:t,tap_action:e?.tap_action??this._config.tap_action??i,hold_action:e?.hold_action??this._config.hold_action,double_tap_action:e?.double_tap_action??this._config.double_tap_action}}_interactive(t){return At(t.tap_action)||At(t.hold_action)||At(t.double_tap_action)}_actionHandler(t){return Ot({hasHold:At(t.hold_action),hasDoubleClick:At(t.double_tap_action),disabled:!this._interactive(t)})}_onAction(t,e){const i=t.detail?.action;i&&function(t,e,i,o){var n;"double_tap"===o&&i.double_tap_action?n=i.double_tap_action:"hold"===o&&i.hold_action?n=i.hold_action:"tap"===o&&i.tap_action&&(n=i.tap_action),kt(t,e,i,n)}(this,this.hass,e,i)}_iconOverlay(t){return t.length?q`
    ...
    `:K}_circleIconSpec(t){const e=this._geom(t);if(!e)return;const i=ee(this._cfg(t),this.hass),o=this._nodeRadius(t),n=!!i.state||!!i.secondary,s=le(Math.round(.62*o),14,40),r=n?e.y-.42*o:e.y-.3*o;return{icon:this._nodeIcon(t),cx:e.x,cy:r,size:s,cls:""}}_badgeIconSpec(t){const e=this._geom(t);if(!e)return;const i=this._nodeRadius(t),o=le(Math.round(.66*i),14,28);return{icon:this._nodeIcon(t),cx:e.x,cy:e.y-.44*i,size:o,cls:""}}_pumpIconSpec(t){const e=this._edgePump(t.key);if(!e?.entity)return;const i=this._geom(t.from),o=this._geom(t.to);if(!i||!o)return;const n=Zt(this.hass,e.entity,e.active_states),s=Math.round(.95*Ut);return{icon:e.icon??Rt,cx:(i.x+o.x)/2,cy:(i.y+o.y)/2,size:s,cls:("pump "+(n?"on":"")).trim()}}_nodeVisible(t){const e=this._cfg(t);return!e?.hidden&&(!!this._geom(t)&&(!(!this._placeholder||!Tt[t])||(this._hasData(e)||"puffer"===t)))}_resolvedEdges(){const t=new Map(Bt.map(t=>[t.key,t])),e=new Set([...t.keys(),...Object.keys(this._config.edges??{})]),i=[];for(const o of e){const e=this._config.edges?.[o],n=t.get(o),s=e?.from??n?.from,r=e?.to??n?.to;s&&r&&i.push({key:o,from:s,to:r})}return i}_renderEdge(t){const e=this._geom(t.from),i=this._geom(t.to);if(!e||!i)return K;const{x1:o,y1:n,x2:s,y2:r}=me(e,i,this._nodeRadius(t.from),this._nodeRadius(t.to)),a=`edge-${t.key}`,c=`M ${o} ${n} L ${s} ${r}`,l=this._config.edges?.[t.key],h=Yt(l,this.hass),d=this._nodeColor(h.reverse?t.to:t.from),u=this._actionsFor(this._edgeEntity(t.key),l);return W`
      <g class="edge-group">
    ...
    `}_renderNode(t,e){return"circle"===this._nodeKind(t)?this._renderCircle(t,e):this._renderBadge(t)}_renderCircle(t,e){const i=this._geom(t);if(!i)return K;const o=this._cfg(t),n=ee(o,this.hass),s=this._nodeColor(t),r=this._nodeRadius(t),a=this._nodeActive(t,e),c=this._placeholder||this._hasData(o)&&!n.available,l=this._isNarrow(),h=!!n.state&&!l,d=!h&&!!n.secondary&&!l,u=h||d,f=n.primary??(c?"—":void 0),p=f?this._fit(f,le(.36*r,12,22),1.55*r):void 0,_=d?this._fit(n.secondary,le(.28*r,10,16),1.5*r):void 0,m=u?i.y+.04*r:i.y+.36*r,g=i.y+.44*r,y=!(!o?.level&&!o?.layers?.length),v=this._actionsFor(this._nodeEntity(t),o);return W`
      <g
        style=${`color:${s}`}
      ...
      >
        ...
        ${p?this._renderText("node-primary",i.x,m,p):K}
        ${h?this._renderPill(i.x,g,r,n.state):K}
        ${_?this._renderText("node-secondary",i.x,g,_):K}
        ${this._renderNodeLabel(t,i,r)}
      </g>
    `}_renderText(t,e,i,o){return W`<text
      class=${t}
      x=${e}
      y=${i}
      dominant-baseline="central"
      ...
      style=${`font-size:${o.fontSize.toFixed(1)}px`}
    >${o.text}</text>`}_renderStratFill(t,e,i,o,n){const s=function(t,e){const i=Vt(e,t?.level??t?.primary);if(void 0!==i)return Math.max(0,Math.min(1,i/100))}(o,this.hass);if(void 0===s||s<=0)return K;const r=this._nodeStroke(t),a=Math.max(0,i-r-.5),c=2*a*s,l=`${t}-clip`,h=`${t}-grad`,d=(o?.layers??[]).map(t=>Vt(this.hass,t)).filter(t=>void 0!==t);let u,f=K;if(d.length>=2){const t=d.map((t,e)=>{const i=e/(d.length-1)*100;return W`<stop offset=${`${i}%`} stop-color=${Qt(t)}></stop>`});f=W`<linearGradient id=${h} x1="0" y1="0" x2="0" y2="1">${t}</linearGradient>`,u=`url(#${h})`}else u=1===d.length?Qt(d[0]):n;return W`
      <defs>
        ${f}
      ...
      <rect
        ...
        clip-path=${`url(#${l})`}
      ></rect>
    `}_renderPill(t,e,i,o){const n=2*i-16,s=this._fit(o,le(.26*i,9,13),n),r=s.textLength??s.text.length*s.fontSize*he,a=Math.min(2*i-6,r+10),c=s.fontSize+6;return W`
      <rect class="pill-bg" x=${t-a/2} y=${e-c/2} width=${a} height=${c} rx=${c/2}></rect>
      ${this._renderText("pill-text",t,e,s)}
    `}_renderBadge(t){const e=this._geom(t);if(!e)return K;const i=this._cfg(t),o=ee(i,this.hass),n=this._nodeColor(t),s=this._nodeRadius(t),r="gauge"===this._nodeKind(t)||!0===i?.gauge?function(t,e){const i=Vt(e,t?.primary);if(void 0===i)return;const o=t?.min??0,n=t?.max??100;return n<=o?void 0:Math.max(0,Math.min(1,(i-o)/(n-o)))}(i,this.hass):void 0,a=this._placeholder||this._hasData(i)&&!o.available,c=e.y+(void 0!==r?.14*s:.2*s),l=this._actionsFor(this._nodeEntity(t),i),h=o.primary??(a?"—":void 0),d=h?this._fit(h,12,1.7*s):void 0,u=1.3*s,f=e.y+.52*s;return W`
      <g
        style=${`color:${n}`}
        class=${this._interactive(l)?"clickable":""}
        ${this._actionHandler(l)}
    ...
    `}_nodeActive(t,e){return e.filter(e=>e.from===t||e.to===t).some(t=>Yt(this._config.edges?.[t.key],this.hass).active)}};ge.styles=ie,t([pt({attribute:!1})],ge.prototype,"hass",void 0),t([_t()],ge.prototype,"_config",void 0),t([_t()],ge.prototype,"_widthPx",void 0),ge=t([dt(Nt)],ge);export{ge as EtaFlowCard,_e as detectRoleEntities};
